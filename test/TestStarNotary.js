...
it('lets 2 users exchange stars', async() => {
    ...
    // 3. Verify that the owners changed
        ...
        let starId_1 = 7;
        let starId_2 = 8;
        await instance.createStar('Star Test 1', starId_1, {from: user1});
        await instance.createStar('Star Test 2', starId_2, {from: user2});
...
it('lets a user transfer a star', async() => {
    ...
    // 3. Verify the star owner changed.
        ...
        let user2 = accounts[2];
        let starId = 9;
        await instance.createStar("Star Test 9", starId, {from: user1});
